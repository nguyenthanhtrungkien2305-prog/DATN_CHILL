...
class HomeController extends Controller
{
    ...
    {
        $data = Cache::remember('chill_home_page_data', 120, function () {
            // 1. Lấy 4 danh mục
            ...
            return compact('categories', 'products', 'cakeProducts', 'combos', 'featuredProduct', 'reviews', 'heroBanner', 'promoBanner');
        });
