        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-4">
                <div class="bg-gray-50 p-5 rounded-2xl">
                    ...
                    <p class="text-gray-800 text-base whitespace-pre-line leading-relaxed italic">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            @if($feedback->status === 'replied')
                ...
                <div class="bg-green-50/50 p-5 rounded-2xl border border-green-100">
                    ...
                    <p class="text-gray-800 text-base whitespace-pre-line leading-relaxed">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="space-y-4 text-sm">
                <div>
                    ...
                    <span class="font-bold text-gray-900 text-base">{{ $feedback->name }}</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span class="font-medium text-gray-800 text-base">{{ $feedback->phone ?? 'Không cung cấp' }}</span>
                </div>
                <div>
