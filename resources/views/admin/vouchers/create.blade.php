            ...
            <form action="{{ route('vouchers.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" placeholder="Ví dụ: 10 (Để trống nếu không giới hạn)" min="1" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:border-[#e8634a]">
                    ...
                    <div>
                        ...
                        <input type="number" name="usage_per_user" value="{{ old('usage_per_user', 1) }}" placeholder="Mặc định: 1" min="1" required class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:border-[#e8634a] font-bold">
