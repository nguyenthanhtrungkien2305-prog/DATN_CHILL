...
@section('title', 'Trợ lý AI Quản lý - Chill Chill Admin')

@section('page_title')
<div class="flex items-center gap-3">
    <span>🤖 Trợ lý AI Quản trị</span>
...
<button id="clear-chat-btn" class="text-sm text-gray-500 hover:text-red-500 flex items-center gap-1 px-3 py-1.5 rounded-lg hover:bg-gray-100 transition mr-2">
    🗑️ Xóa hội thoại
</button>
...
@section('content_class', 'flex-1 flex p-6 gap-6 overflow-hidden')
