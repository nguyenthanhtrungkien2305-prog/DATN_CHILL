...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-[#2B2623] text-white flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="{{ route('categories.index') }}" class="block px-4 py-3 rounded-lg bg-[#e8634a] text-white font-medium">📁 Quản lý Danh mục</a>
            <a href="{{ route('products.index') }}" class="block px-4 py-3 rounded-lg hover:bg-white/10 transition">☕ Quản lý Sản phẩm</a>
