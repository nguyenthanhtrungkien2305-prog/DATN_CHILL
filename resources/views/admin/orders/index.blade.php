    ...
    <form action="{{ route('orders.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <div class="flex gap-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Nhập mã đơn, tên, số điện thoại..." class="flex-1 px-4 py-2 border rounded-xl focus:outline-none focus:border-[#e8634a] text-sm bg-gray-50 focus:bg-white transition-all text-espresso">
            </div>
        </div>
        ...
        <div>
            ...
            <select name="status" class="w-full px-4 py-2 border rounded-xl focus:outline-none focus:border-[#e8634a] text-sm bg-gray-50 text-espresso">
        ...
        <div>
            ...
            <select name="order_type" class="w-full px-4 py-2 border rounded-xl focus:outline-none focus:border-[#e8634a] text-sm bg-gray-50 text-espresso">
        ...
        <div class="col-span-1 md:col-span-4 flex justify-end gap-2 pt-2 border-t border-gray-50">
            @if(request()->anyFilled(['search', 'status', 'order_type', 'user_id']))
                <a href="{{ route('orders.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2 rounded-xl transition text-sm font-medium">Xóa bộ lọc</a>
            @endif
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-gray-700 text-sm divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="p-4">
                        <div class="font-bold text-espresso">{{ $order->customer_name }}</div>
