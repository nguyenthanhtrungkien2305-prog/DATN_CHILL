            ...
            <div class="w-full md:w-2/3 p-8 md:p-12">
                ...
                <form action="{{ route('user.update_profile') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex items-center gap-6 mb-8 pb-8 border-b border-espresso/10">
                        <div class="w-24 h-24 rounded-full border-4 border-[#FAF7F2] shadow-sm overflow-hidden bg-gray-100 relative group">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateFinalAddress() {
            ...
            if (district || ward || street) {
                ...
                // Vì address giờ lưu mảng, ta cần biến chuỗi này thành định dạng mảng JSON [ "Địa chỉ mới" ]
